...
.3 socket\_tools.c/.h - Outils permettant de faciliter la manipulation de sockets (initialisation d'une socket serveur/cliente, envoi et réception de données)..
.3 TP-DIST-CL.c.
.3 TP-DIST.c.
.2 Vagrantfile.
.2 Vagrantprov.sh.
